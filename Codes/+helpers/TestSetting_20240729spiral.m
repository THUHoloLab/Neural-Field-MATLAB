function [dsTrain, dsValid, params] = TestSetting_20240729spiral
% This helper function uses a labeled data set which comes from NeRF synthetic
% dataset
% Copyright 2023 The MathWorks, Inc.

datasetPath = fullfile("data/goniophotometer","20240730spiral2");
...
% camPosesTrain = {trTrain.frames.transform_matrix};
% camPosesValid = {trVal.frames.transform_matrix};
